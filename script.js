function generateResults() {
    const results = {
        honestyHumility: document.getElementById('honestyHumility').value,
        ...
        emotionality: document.getElementById('emotionality').value,
    ...
    document.getElementById('results').innerHTML = `
        <h2>결과</h2>
        <p>정직-겸손 (HONESTY-HUMILITY): ${results.honestyHumility}</p>
        <ul>
        ...
        <p>감정성 (EMOTIONALITY): ${results.emotionality}</p>
        <ul>
        ...
        <p>외향성 (EXTRAVERSION): ${results.extraversion}</p>
        <ul>
        ...
        <p>우호성 (AGREEABLENESS): ${results.agreeableness}</p>
        <ul>
        ...
        <p>성실성 (CONSCIENTIOUSNESS): ${results.conscientiousness}</p>
        <ul>
        ...
        <p>개방성 (OPENNESS): ${results.openness}</p>
        <ul>
